...
namespace netcore.Controllers.Api
{
    ...
    public class DashboardController : Controller
    {
        ...
        //{
        //    var customerWarehouses = Enum.GetValues(typeof(Models.Invent.Warehouse));
        ...
        //    int i = 0;
        //    foreach (var item in customerWarehouses)
        //    {
        //        int count = _context.Warehouse.Where(x => x.customer.Equals(item)).Count();
