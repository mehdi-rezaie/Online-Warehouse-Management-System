...
namespace netcore.Controllers.Invent
{
    ...
    public class ReceivingLineController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("receivingLineId,receivingId,branchId,warehouseId,productId,width,height,thickness,weight,qty,qtyReceive,qtyInventory,createdAt")] ReceivingLine receivingLine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("receivingLineId,receivingId,branchId,warehouseId,productId,width,height,thickness,qty,weight,qtyReceive,qtyInventory,createdAt")] ReceivingLine receivingLine)
        {
