...
namespace netcore.Controllers.Invent
{
    ...
    public async Task<IActionResult> Create([Bind("purchaseOrderLineId,purchaseOrderId,productId,width,height,thickness,qty,weight,price,batchNumber,palletBundle,discountAmount,totalAmount,createdAt")] PurchaseOrderLine purchaseOrderLine)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(string id, [Bind("purchaseOrderLineId,purchaseOrderId,productId,width,height,thickness,qty,weight,price,batchNumber,palletBundle,discountAmount,totalAmount,createdAt")] PurchaseOrderLine purchaseOrderLine)
    {
