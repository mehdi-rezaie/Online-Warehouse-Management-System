...
namespace netcore.Controllers.Invent
{
    ...
    public class SalesOrderController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("salesOrderId,salesOrderNumber,top,soDate,deliveryDate,deliveryAddress,vehicleNumber,description,customerId,branchId,salesOrderStatus,totalDiscountAmount,totalOrderAmount,salesShipmentNumber,HasChild,createdAt")] SalesOrder salesOrder)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("salesOrderId,salesOrderNumber,top,soDate,deliveryDate,deliveryAddress,vehicleNumber,description,customerId,branchId,salesOrderStatus,totalDiscountAmount,totalOrderAmount,salesShipmentNumber,HasChild,createdAt")] SalesOrder salesOrder)
        {
