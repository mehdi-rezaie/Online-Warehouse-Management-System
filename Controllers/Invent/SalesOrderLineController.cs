...
namespace netcore.Controllers.Invent
{
    ...
    public class SalesOrderLineController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("salesOrderLineId,salesOrderId,productId,width,height,thickness,qty,weight,batchNumber,palletBundle,price,discountAmount,totalAmount,createdAt")] SalesOrderLine salesOrderLine)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("salesOrderLineId,salesOrderId,productId,width,height,thickness,qty,bacthNumber,palletBundle,price,discountAmount,totalAmount,createdAt")] SalesOrderLine salesOrderLine)
        {
